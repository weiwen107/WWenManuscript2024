...
save_file_name = 'AHP_220923.mat';

% Name of the fI analyzed data file
fI_name = 'fI_220923.mat';
...
%         plot(data)
        ...
        if spike_count{1,ci}(trace_id,1) == 1 
            first_ap_end = first_ap_start + 180/1000*sprate;
...
if save_results == 1
    cd (fp_AHP)
    save(save_file_name,'cell_id','first_ap_data','first_ap_data_norm','first_ap_dV','AHP_peak_amp','AHP_duration','AHP_area')
end