...
fp_fap = '/Users/wwneuro/My_Drive/Lab/Data_analysis/culture_experiments/AP_raw_data/firstAP';
...
for si = 1:numel(cell_id)
   if isnan(rheobase_ind(si,1)) || rheobase_ind(si,1) == 0
       continue
   else
       ...
       elseif select_mode == 2
        ...
        if isnan(V_th{1,si}{1,trace_current}(1,1)) || isnan(f_trough{1,si}{1,trace_current}(1,1))
            continue
        else
