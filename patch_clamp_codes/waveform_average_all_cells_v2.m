...
fp_wa_group = ...,
    '/Users/wwneuro/My_Drive/Lab/Data_analysis/slice_NT/waveform_average_by_groups/';

%experimental conditions
exp_con = {'Dark','Light_6h','Dark_6h'};

%import cell_id_index table 
fp_mini_group = '/Users/wwneuro/My_Drive/Lab/Data_analysis/slice_NT/mini_data_by_groups';
cd(fp_mini_group)
cell_id_index = readtable('cell_id_index.xlsx','Sheet',strcat(exp_name,'_',sub));

%location of waveform average files (per cell)
fp_wak = '/Users/wwneuro/My_Drive/Lab/Data_analysis/slice_NT/waveform_average_kinetics/';
        ...
        for ci = 1:size(wavg_per_cell{1,1},2)
            if sum(wavg_per_cell{1,1}(:,ci)) == 0
                ...
                if isempty(find(cell_id_index.Date == date & cell_id_index.Cell_num == ci,1))
                    ...
                    all_wavg{1,cond_i}(1:numel(wavg_per_cell{1,1}(:,ci)),cell_ID) = wavg_per_cell{1,1}(:,ci);
                end
            end
        end
    end
...
%cultured neuron + TTX/GLYX color scheme
% color1 = '#573E5C'; 
% color2 = '#AFCFE8';
